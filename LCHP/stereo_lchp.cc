...
int main(int argc, char **argv)
{
    if(argc != 7)
    {
        cerr << endl << "Usage: ./stereo_lchp path_to_vocabulary path_to_settings path_to_left_folder path_to_right_folder path_to_times_file path_to_trajectory_dir" << endl;
        return 1;
    }
    ...
    string strTrajectorySaveDir = string(argv[6]);
    ...
    ORB_SLAM2::System SLAM(argv[1],argv[2],ORB_SLAM2::System::STEREO,true); // SLAM(Vocabulary, path_to_settings)
