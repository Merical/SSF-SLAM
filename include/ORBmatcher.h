...
//    ORBmatcher(float nnratio=0.6, bool checkOri=true);
    ORBmatcher(float nnratio=0.6, bool checkOri=false); //lch change here

    // Computes the Hamming distance between two ORB descriptors
    static float DescriptorDistance(const cv::Mat &a, const cv::Mat &b);
    static int DescriptorDistanceHamming(const cv::Mat &a, const cv::Mat &b);
    ...
    int SearchByNN(KeyFrame *pKF1, KeyFrame* pKF2, std::vector<MapPoint*> &vpMatches12);
